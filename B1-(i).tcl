# 
# Write a tcl program in ns2 to create a network with three nodes and establish a
# TCP connection between node 0 and node 1 such that node 0 will send TCP packet to
# node 2 via node 1.
#
